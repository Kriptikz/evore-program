...
pub fn process_mm_strat_full_autodeploy(
    ...
    let args = MMStratFullAutodeploy::try_from_bytes(instruction_data)?;
    ...
    // ======================================================================
    // STEP 5: Fee calculation + balance check
    // ======================================================================
    ...
    // ======================================================================
    // STEP 6: Pay fees (only on first deploy of the round)
    // ======================================================================
